...
class ResponseConfig {
    var respCode = HashMap<String, String>()

    companion object {
        // Create a HashMap object called capitalCities
        var startTrxn = false
        var loadurl = false
        var finalRespJson: JSONObject? = null
        var merchanKey: String? = null
    }

    init {
        respCode["result"] = "1"
        respCode["1"] = "Approved, Pending for Authorisation"
        respCode["0"] = "Transaction Successful"
        ...
        respCode["230 "] = "Instrument type not Supported"
         ...
         respCode.put("16="Approved, update track 3";
         respCode.put("17="Operator Cancelled";
         respCode.put("18="Customer dispute";
         respCode.put("19="Re enter transaction";
         respCode.put("20="Invalid response";
         respCode.put("21="No action taken";
         respCode.put("22="Suspected malfunction";
         respCode.put("23="Unacceptable transaction fee";
         respCode.put("24="File update not supported";
         respCode.put("25="Unable to locate record";
         respCode.put("26="Duplicate record";
         respCode.put("27="File update edit error";
         respCode.put("28="File update file locked";
         respCode.put("30="File update failed";
         respCode.put("31="Bank not supported";
         respCode.put("32="Completed partially";
         respCode.put("33="Expired card, pick-up";
         respCode.put("34="Suspected fraud, pick-up";
         respCode.put("35="Contact acquirer, pick-up";
         respCode.put("36="Restricted card, pick-up";
         respCode.put("37="Call acquirer security, pick-up";
         respCode.put("38="PIN trie respCode.put("xceeded, pick-up";
         respCode.put("39="No credi respCode.put("ccount";
         respCode.put("40="Function respCode.put("t supported";
        public static String app41="Lost car respCode.put("Contact Bank)";
        public static String app42="No unive respCode.put("l account";
        public static String app43="Stolen card"; respCode.put("
